...
},{"moo":81}],79:[function(require,module,exports) {
var define;
...
var Html = function (_AbstractRenderer_1$A) {
    _inherits(Html, _AbstractRenderer_1$A);
    ...
    _createClass(Html, [{
        ...
        value: function cmd(name, arg) {
            this.top().appendChild(util_1.e('div', {
                'data-cmd': name,
                'data-arg': arg
            }));
        }
        ...
        value: function startEnv(type) {
            this.push(util_1.e('div', { align: 'center' }));
        }
    }, {
        key: "endEnv",
        ...
        value: function hr() {
            this.clear();
            this.top().appendChild(util_1.e('hr'));
        }
    }, {
        key: "sync",
        value: function sync(el, id) {
        ...
        key: "tikz",
        value: function tikz(_tikz, id) {
            var img = util_1.e('img', { 'class': 'tikz' });
...
exports.Html = Html;
},{"katex":79,"./AbstractRenderer":80,"./util":14}],15:[function(require,module,exports) {
"use strict";
...
var Syntax = function (_AbstractRenderer_1$A) {
    ...
    _createClass(Syntax, [{
        key: "cmd",
        value: function cmd(name, arg) {
            var cmd = this.element('cmd', "\\" + name + "{" + arg + "}");
        ...
        key: "element",
        value: function element(type, val, id) {
        ...
        value: function hr() {
            this.clear();
            var hr = this.element('hr', '--');
            this.top().appendChild(hr);
        }
    }, {
        key: "pushDirAutoBlock",
        value: function pushDirAutoBlock() {
        ...
        key: "popDirAutoBlocks",
        value: function popDirAutoBlocks() {
            while (this.top().className === 'dir-auto') {
                this.pop();
            }
        }
    }, {
        ...
        value: function startElement(e, id) {
            ...
            var type = e.type;
            var el = this.element(type, e.token, id);
            this.push(el);
        }
    }, {
        key: "endElement",
        ...
        value: function startEnv(type) {
            console.log('<', type);
            var env = this.element('env-s', "\\" + type);
        ...
        value: function endEnv(type) {
            console.log(type, '>');
            var env = this.element('env-e', "\\" + type);
            this.top().appendChild(env);
        }
    }, {
        key: "esc",
        ...
        value: function eol() {
            console.log('eol');
            this.popDirAutoBlocks();
            var dataType = this.top().getAttribute('data-type');
        ...
        value: function a(title, href, id) {
            console.log('a');
            var a = this.element('a', "[" + title + "](" + href + ")", id);
            this.top().appendChild(a);
        }
    }, {
        key: "img",
        value: function img(title, src, id) {
            var img = this.element('img', "![" + title + "](" + src + ")", id);
            this.top().appendChild(img);
        }
    }, {
        key: "$",
        value: function $(tex, id) {
            var $ = this.element('$', tex, id);
        ...
        value: function tikz(val, id) {
            var tikz = this.element('tikz', val, id);
...
},{"./AbstractRenderer":80,"./util":14}],16:[function(require,module,exports) {
"use strict";
...
},{"texdown":78,"../Html":13,"../Syntax":15,"../util":14,"../welcome":16,"../SyncCol":17}]},{},[9], null)
//# sourceMappingURL=/edit.b55e234f.map